                ...
                <div class="tab-pane active in" id="home">
                    <form id="userform" name="userform" action="/calendar/registration" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown('service_id', $sys_globals["service"], null, array('class' => 'form-control')); ?>
                        </div>
                        <div class="form-group">
                            <div class="form-check">
                                <label style="width: 80px;">monday&nbsp;</label>

                                <input class="form-check-input" name="monday" type="radio" id="mon_yes" checked="checked" value="1">
                                <label class="form-check-label" for="mon_yes">yes</label>

                                <input class="form-check-input" name="monday" type="radio" id="mon_no" value="0">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" name="tuesday" type="radio" id="tue_yes" checked="checked" value="1">
                                <label class="form-check-label" for="tue_yes">yes</label>

                                <input class="form-check-input" name="tuesday" type="radio" id="tue_no" value="0">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" name="wednesday" type="radio" id="wed_yes" checked="checked" value="1">
                                <label class="form-check-label" for="wed_yes">yes</label>

                                <input class="form-check-input" name="wednesday" type="radio" id="wed_no" value="0">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" name="thursday" type="radio" id="thu_yes" checked="checked" value="1">
                                <label class="form-check-label" for="thu_yes">yes</label>

                                <input class="form-check-input" name="thursday" type="radio" id="thu_no" value="0">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" name="friday" type="radio" id="fri_yes" checked="checked" value="1">
                                <label class="form-check-label" for="fri_yes">yes</label>

                                <input class="form-check-input" name="friday" type="radio" id="fri_no" value="0">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" name="saturday" type="radio" id="sat_yes" checked="checked" value="1">
                                <label class="form-check-label" for="sat_yes">yes</label>

                                <input class="form-check-input" name="saturday" type="radio" id="sat_no" value="0">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" name="sunday" type="radio" id="sun_yes" checked="checked" value="1">
                                <label class="form-check-label" for="sun_yes">yes</label>

                                <input class="form-check-input" name="sunday" type="radio" id="sun_no" value="0">
